  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Your ultimate solution for seamless human resources operations. Empower your team with our innovative tools."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Your ultimate solution for seamless human resources operations. Empower your team with our innovative tools.`}
            </Text>
            <Box
